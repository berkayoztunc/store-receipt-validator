 ...
 * @group library
 */
class TunesValidatorTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->validator = new TunesValidator(TunesValidator::ENDPOINT_SANDBOX);
    }
    ...
    public function testInvalidOptionsToConstructor(): void
    {
        ...
        new TunesValidator('in-valid');
    }


    public function testSetEndpoint(): void
    {
        $this->validator->setEndpoint(TunesValidator::ENDPOINT_PRODUCTION);

        $this->assertEquals(
            TunesValidator::ENDPOINT_PRODUCTION,
