...
PHP library that can be used to validate base64 encoded Tunes in app purchase receipts.
...
use ReceiptValidator\Tunes\Validator as TunesValidator;

$validator = new TunesValidator(TunesValidator::ENDPOINT_PRODUCTION); // Or TunesValidator::ENDPOINT_SANDBOX if sandbox testing
...
try {
  ...
  // $sharedSecret = '1234...'; // Generated in Tunes Connect's In-App Purchase menu
